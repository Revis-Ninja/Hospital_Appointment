...
public class TYishengDAO extends HibernateDaoSupport {
	...
	public static final String YISHENG_PWD = "yishengPwd";
	...
	public TYisheng findById(java.lang.Integer id) {
		...
		try {
			TYisheng instance = (TYisheng) getHibernateTemplate().get("com.model.TYisheng", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TYisheng instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from TYisheng as model where model." + propertyName + "= ?";
	...
	public List findByYishengPwd(Object yishengPwd) {
		return findByProperty(YISHENG_PWD, yishengPwd);
	}
	...
	public TYisheng merge(TYisheng detachedInstance) {
		...
		try {
			TYisheng result = (TYisheng) getHibernateTemplate().merge(detachedInstance);
