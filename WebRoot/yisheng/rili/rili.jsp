...
<%
    ...
    String now=year+"year"+(month+1)+"month"+today+"day"+weekdays[weekday];
    ...
    <body onload="showTime(time)">
        <table width="170" border="0" align="center" cellspacing="1">            
            <tr height="25" bgcolor="#F0F0F0" align="center" style="font-size: 12px;">
                ...
                <td style="border:1 solid">Mon</td>
                <td style="border:1 solid">Tue</td>
                <td style="border:1 solid">Wed</td>
                <td style="border:1 solid">Thu</td>
                <td style="border:1 solid">Fri</td>
                <td style="border:1 solid">Sat</td>
            </tr>
